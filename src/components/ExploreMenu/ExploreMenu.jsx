...
export default function ExploreMenu({category, setCategory}) {
  return (
    <div className="explore-menu   flex flex-col gap-[20px]" id='explore-menu'>
      ...
      <p className="explore-menu-text max-w-[60%]  text-[#808080]">Choose from diverse menu featuring a delectable array of dishes. Our mission is to satisfy your cravings and elevate your dining experience, one delicious meal at time</p>
      <div className=" explore-menu-list explore-menu-list  flex justify-between  items-center gap-[30px] text-center m-[20px_0px] overflow-x-auto whitespace-nowrap scrollbar-hide">
